...
public class AccountPreconditionRuntimeException extends AccountBaseRuntimeException {
    public AccountPreconditionRuntimeException(String message) {
        super(
    ...
    public AccountPreconditionRuntimeException() {
        super(
                AccountErrors.ACCOUNT_PRECONDITION_FAILED.getCode(),
